...
/* macros.twig */
class __TwigTemplate_69589a7c29037ff8599d14e847e396cc43881cfd22e1d2262bb0c6b9feaa47ec extends Twig_Template
{
...
";
    ...
    <table class=\"form-table\">
        ...
        <tr valign=\"top\">
            ...
            // line 19
            echo twig_escape_filter($this->env, (isset($context["wp_version"]) ? $context["wp_version"] : null), "html", null, true);
            echo "\" />
                <input type=\"hidden\" id=\"plugins\" name=\"plugins\" value=\"";
            // line 20
            echo twig_escape_filter($this->env, (isset($context["installed_plugins"]) ? $context["installed_plugins"] : null), "html", null, true);
            echo "\" />
            ...
            // line 22
            echo twig_escape_filter($this->env, (isset($context["return_to_url"]) ? $context["return_to_url"] : null), "html", null, true);
            echo "\" />
    ...
    <p style=\"text-align: right\">
        <a href=\"";
            // line 28
            echo (isset($context["return_to_url"]) ? $context["return_to_url"] : null);
...
";
    ...
    public function getrecipe_attr($__attr_name__ = null, $__attr_value__ = null, $__amp_on__ = null, ...$__varargs__)
    {
        ...
        try {
            // line 78
            echo "    ";
            if ( !(isset($context["amp_on"]) ? $context["amp_on"] : null)) {
                // line 79
                echo "        ";
                echo twig_escape_filter($this->env, (isset($context["attr_name"]) ? $context["attr_name"] : null), "html", null, true);
                if ((isset($context["attr_value"]) ? $context["attr_value"] : null)) {
                    echo "=\"";
                    echo twig_escape_filter($this->env, (isset($context["attr_value"]) ? $context["attr_value"] : null), "html", null, true);
                    echo "\"";
                }
                // line 80
                echo "    ";
    ...
    {
        return new Twig_Source("", "macros.twig", "/nas/content/live/natalierose/wp-content/plugins/zip-recipes/views/macros.twig");
    }
}
