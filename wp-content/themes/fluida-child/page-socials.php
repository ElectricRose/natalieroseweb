	...
	<div id="container" class="<?php echo fluida_get_layout_class(); ?>">
      ...
      <div class="social-section">
        ...
        <div class="social-block1">
          <img src="http://localhost:8888/natalierose/wp-content/uploads/2018/01/Insta3.jpg" alt="social media ad design">
        ...
        <div class="social-block2">
          <img src="http://localhost:8888/natalierose/wp-content/uploads/2018/01/socialmediatemplates1.png" alt="social media template design">
        ...
        <div class="social-block3">
          ...
          <img src="http://localhost:8888/natalierose/wp-content/uploads/2018/02/facebook-yoga1-700.png" alt="facebook cover design">
        </div>
        ...
        <div class="social-block4">
          <img src="http://localhost:8888/natalierose/wp-content/uploads/2018/02/businesscard2-400.png" alt="business card design">
          <h1>Business Card</h1>
