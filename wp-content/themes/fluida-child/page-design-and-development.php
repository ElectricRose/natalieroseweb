<?php /* Template Name: Design and Development */ ?>
<?php
/**
 * The template for displaying the design and development page.
 *
    ...
    <div class="work-section3">
      ...
      <div class="work-package-gold">
        <div class="package1">
          ...
          <p><div class="work-bold"> What you get</p></div>
            <ul>
            ...
            <p>Options Include, but are not limited to:</p><br>
            <ul>
      ...
      <div class="work-package-gold">
        <div class="package2">
          ...
          <p><div class="work-bold">What I offer</div></p>
          <ul>
