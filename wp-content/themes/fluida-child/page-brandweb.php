	...
	<div id="container" class="<?php echo fluida_get_layout_class(); ?>">
      ...
      <div class="brandweb-content">
        ...
        <div class="brandweb-box1">
          ...
          <p>What you get</p>
            <ul>
              ...
              <li>Logo creation</li>
              <p>I will craft 2 unique and memorable logo designs based on your brand personality and vison.</p>
        ...
        <div class="timebox">
          ...
          Investment: $825+<br>
          4 payments of $206.25<br>
          $725 when paid in full (save $100)</p>
        </div>
        ...
        <div class="timebox">
          ...
          Investment: $1045+<br>
          4 payments of $261.25<br>
          $945 when paid in full (Save $100)<br>
        ...
        <div class="timebox">
          <p>Timeline 12+ weeks<br>
            Investment: Starting at $2400+<br>
            Payment installment options available.<br>
            Both the timeline and investments are dependant on website size and complexity.</p>
          </div>
